...
set :application, 'temirtulpar_erp'
# set :repo_url, 'git@bitbucket.org:spalmalo/temirtulpar_erp.git'
set :repo_url, 'git@github.com:OverseerY/ZTTA_ERP.git'

set :deploy_to, "/opt/temirtulpar_erp"
